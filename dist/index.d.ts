...
export declare function createEnumCase<T extends readonly Constructor[]>(...traits: T): new <K extends string, V extends string | number>(name: K, value: V) => EnumCase<K, V> & UnionToIntersection<InstanceType<T[number]>>;
